...
\begin{figure}[ht]
    ...
    \caption{Latências P50/P95/P99 por carga (VUs) no cenário de leitura. A linha tracejada indica o SLO de 450~ms, não violado durante o teste.}
...
\begin{figure}[ht]
    ...
    \caption{Latências P50/P95/P99 por carga (VUs) no cenário misto. A faixa tracejada marca o SLO e o ponto vertical sinaliza a violação aos 149~VUs.}
