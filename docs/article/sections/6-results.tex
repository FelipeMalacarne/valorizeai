...
A Tabela~\ref{tab:custos_final} resume a comparação econômica entre Cloud Run, GKE e Compute Engine, enquanto a Figura~\ref{fig:custo-relativo} ilustra o comportamento relativo de custo ao longo do tempo, normalizado para Compute Engine = 1{,}0.
