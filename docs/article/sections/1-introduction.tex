...
a Seção~\ref{sec:metodologia} detalha a metodologia experimental;
a Seção~5 descreve a implementação e os resultados obtidos;
e a Seção~6 traz as conclusões e trabalhos futuros.
