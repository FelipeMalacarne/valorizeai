...
Assim que a carga ultrapassou 550 VUs, o Cloud Run atingiu novamente o teto de 10 instâncias e o P95 consolidado do ensaio ficou em 658~ms, com p99 em 2,67~s e máximo de 2,67~s (sem saltos superiores). A pressão veio do aumento de CPU e latência nas operações de escrita, já que cada instância precisou executar validações, persistência e invalidação de cache antes de responder; não houve evidência de saturação no Cloud SQL, cujos tempos de consulta permaneceram estáveis durante todo o gradiente.
