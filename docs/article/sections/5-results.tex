...
Com 650 usuários alternando entre 65\% de leituras e 35\% de escritas durante 21 minutos, o sistema sustentou 226 requisições por segundo (283~mil iterações) sem erros e preservou o SLO de 300~ms até aproximadamente 450 RPS.
Assim que a carga ultrapassou 550 VUs, o Cloud Run atingiu novamente o teto de 10 instâncias e a cauda longa explodiu: o P95 consolidado do ensaio ficou em 658~ms, enquanto o percentil 99 se aproximou de 7~s.
As traces do Cloud SQL mostraram que os 20\% de POSTs seguram locks linha/índice por até 2{,}6~s quando várias instâncias tentam atualizar o mesmo conjunto de contas, o que se reflete diretamente no alongamento das filas HTTP.
Mesmo com o balanceamento aperfeiçoado, o comportamento de cauda longa evidencia a necessidade de evoluir o particionamento dos dados e elevar o número máximo de instâncias do serviço HTTP antes de buscar cargas ainda maiores.
Também ficou evidente o benefício do endpoint de provisionamento: cada VU pôde criar contas próprias e evitar competição por saldo, aproximando o teste de um uso real.
