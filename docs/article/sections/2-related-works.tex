...
Os fatores comparados deixam claro que a literatura cobre fragmentos isolados do problema. No Capítulo \ref{sec:fundamentacao}, esses referenciais são consolidados em um vocabulário comum (Clean Architecture, DDD, SRE, EDA) que sustenta a proposta do ValorizeAI antes de avançarmos para a metodologia e a implementação.
